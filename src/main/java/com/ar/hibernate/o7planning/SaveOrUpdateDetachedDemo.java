...
//			}
	...
	private static Long getMaxEmpId(Session session) {
		// TODO Auto-generated method stub
		String queryString = "Select max(e.empId) from " + Employee.class.getName() + " e";
	...
	private static Employee getEmployee_Detached() {
		SessionFactory factory = CustomSessionFactory.getSessionFactory();
		...
		try {
			...
			Long maxEmpId = getMaxEmpId(session1);
			System.out.println(" - Max Emp ID " + maxEmpId);

			Employee emp2 = findEmployee(session1, "E7839");
